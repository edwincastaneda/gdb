...
<div class="row">
	<div class="col-md-12">
		<table style="width:100%;">
			<tr>
				<td class="text-left"><h3 class="text-muted">Grupos</h3></td>
...
<form method=post action="ctrl/ctrl_grupos.php">
...
<tr>
	...
	<td>
		<div class="input-group">
			...
			<input type="hidden" id="id_facilitador" name="id_facilitador" value="<?php if(isset($edit[1])){echo $edit[1];}?>"/>
...
<tr>
	...
	<td>
		<div class="input-group">
                    <input type="text" class="form-control input-sm" type="text" id="nombre_lider" value="<?php if(isset($edit[2])){echo utf8_encode($db->getNombreLideres($edit[2]));}?>" required="" readonly placeholder="NO SELECCIONADO"/>
			<input type="hidden" id="id_lider" name="id_lider" value="<?php if(isset($edit[2])){echo $edit[2];}?>"/>
			<span class="input-group-btn">
...
<tr>
	...
	<td>
	<input class="form-control input-sm" type="text" name="direccion" value="<?php if(isset($edit[4])){echo $edit[4];}?>" required="">
	</td>
</tr>
<tr>
...
<table class="table" id="catalogo_form">
    <tr>
        ...
        <td class="mostrarPermisosCheck"><input type="checkbox" id="i2"></td>
    ...
    <tr>
        ...
        <td class="mostrarPermisosCheck"><input type="checkbox" id="i8"></td>
...
<thead>
	...
	<th class="head-3">Anfitrión</th>
        <th class="head-4">Dirección</th>
        <th class="head-5">Teléfono</th>
        <th class="head-6">Día</th>
        <th class="head-7">Horario</th>
	<th class="head-8">Directrices</th>
	<th class="head-9">Transporte</th>
        <th class="head-10">Acciones</th>
    </tr>
</thead>
<tbody>
<?php 
...
if($db->num_rows($consulta)>0){
  while($results = $db->fetch_array($consulta)){ 
   ...
   echo "<td class='column-3'>".utf8_encode($results['anfitrion'])."</td>"; 
   echo "<td class='column-4'>".utf8_encode($results['direccion'])."</td>";
   echo "<td class='column-5'>".$results['telefono']."</td>";
   echo "<td class='column-6'>".utf8_encode($results['dia'])."</td>";
   echo "<td class='column-7'>".$results['hora_inicia']." - ".$results['hora_finaliza']."</td>";
   echo "<td class='column-8'>".$results['directrices']."</td>";
   echo "<td class='column-9'>".$results['transporte']."</td>";
   echo "<td class='column-10'>";
